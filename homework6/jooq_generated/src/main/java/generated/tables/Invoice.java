...
public class Invoice extends TableImpl<InvoiceRecord> {
     ...
     */
    public final TableField<InvoiceRecord, Integer> ID = createField(DSL.name("id"), SQLDataType.INTEGER.nullable(false), this, "");
     ...
     */
    public final TableField<InvoiceRecord, Integer> ORGANIZATION_SENDER = createField(DSL.name("organization_sender"), SQLDataType.INTEGER.nullable(false), this, "");
    ...
    public List<ForeignKey<InvoiceRecord, ?>> getReferences() {
        return Arrays.asList(Keys.INVOICE__INVOICE_ORGANIZATION_SENDER_FKEY);
    }
    ...
    public Organization organization() {
        if (_organization == null)
            _organization = new Organization(this, Keys.INVOICE__INVOICE_ORGANIZATION_SENDER_FKEY);
