...
public class InvoiceRecord extends UpdatableRecordImpl<InvoiceRecord> implements Record3<Integer, LocalDateTime, Integer> {
     ...
     */
    public InvoiceRecord setDate(LocalDateTime value) {
        set(1, value);
        return this;
    }
    ...
    @Override
    public InvoiceRecord values(Integer value1, LocalDateTime value2, Integer value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public InvoiceRecord(Integer id, LocalDateTime date, Integer organizationSender) {
        super(Invoice.INVOICE);
